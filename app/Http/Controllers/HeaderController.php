...
class HeaderController extends Controller
{
    ...
    public function entriSurat(Request $request)
    {
        $validateData = $request->validate([
            'iddevice' => 'required',
            'token' => 'required',
        ...
        try {
            // Mengirimkan request GET dengan multipart
            $response = $client->post('https://siappws.dipendajatim.go.id/pemda/index.php/surat/entri', [
                'headers' => $headers,
                'form_params' => $fields
            ]);
    ...
    public function LaporanPetugas(Request $request)
    {
        ...
        try {
            // Mengirimkan request GET dengan multipart
            $response = $client->post('https://siappws.dipendajatim.go.id/pemda/index.php/laporan/lapPerPetugas', [
                'headers' => $headers,
                'form_params' => $fields
            ]);
